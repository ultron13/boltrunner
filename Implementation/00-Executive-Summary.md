...
BoltRunner Enterprise is an enterprise performance testing platform that combines LoadRunner Enterprise-style test management with Kubernetes-native execution.
...
BoltRunner should provide the core features expected from a LoadRunner Enterprise alternative:
...
BoltRunner should go beyond traditional platforms with:
