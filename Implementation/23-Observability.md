...
BoltRunner should correlate system-under-test telemetry with load generator metrics to identify whether failures originate from the application, infrastructure, network, data layer, or test engine.
